...
@Component({
  selector: 'app-top-monthly',
  templateUrl: './top-monthly.component.html',
  styleUrls: ['./top-monthly.component.scss'],
})
export class TopMonthlyComponent implements OnInit, OnDestroy {
  readonly TOP_DURATION: TopDuration = 'monthly';
  comics: Comic[] = [];
  page: number = 1;
  totalPages = 1;
  status: Status = 'all';
  ...
  private seoData() {
    ...
    this.seoService.setSeoData('Top Tháng - Trang ' + this.page, des);
  }
  ngOnDestroy(): void {
