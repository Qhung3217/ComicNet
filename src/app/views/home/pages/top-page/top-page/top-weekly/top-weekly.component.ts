...
@Component({
  selector: 'app-top-weekly',
  templateUrl: './top-weekly.component.html',
  styleUrls: ['./top-weekly.component.scss'],
})
export class TopWeeklyComponent implements OnInit, OnDestroy {
  readonly TOP_DURATION: TopDuration = 'weekly';
  comics: Comic[] = [];
  page: number = 1;
  totalPages = 1;
  status: Status = 'all';
  ...
  private seoData() {
    ...
    this.seoService.setSeoData('Top Tuần - Trang ' + this.page, des);
  }
  ngOnDestroy(): void {
